...
ALTER TABLE Customer ADD CONSTRAINT ContactPerson_fk FOREIGN KEY (ContactPerson_ID) REFERENCES Person(Person_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE Invoice ADD CONSTRAINT SalesPerson_fk FOREIGN KEY (SalesPerson_ID) REFERENCES Person(Person_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE InvoiceProduct ADD CONSTRAINT Passenger_fk FOREIGN KEY (Passenger_ID) REFERENCES Passenger(Passenger_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE Product ADD CONSTRAINT ArrAirport_fk FOREIGN KEY (ArrAirport_ID) REFERENCES Airport(Airport_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE Product ADD CONSTRAINT DepAirport_fk FOREIGN KEY (DepAirport_ID) REFERENCES Airport(Airport_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE Person ADD CONSTRAINT Address_fk FOREIGN KEY (Address_ID) REFERENCES Address(Address_ID)ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE Passenger ADD CONSTRAINT Product_fk FOREIGN KEY (Product_ID) REFERENCES Product(Product_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE Passenger ADD CONSTRAINT Person_fk FOREIGN KEY (Person_ID) REFERENCES Person(Person_ID) ON DELETE RESTRICT ON UPDATE CASCADE;
