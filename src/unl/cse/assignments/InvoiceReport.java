...
public class InvoiceReport {
    ...
    public static void main(String args[]) {
        ...
        String getInvoice = "select Invoice_ID, InvoiceCode, CustomerCode, "
        ...
        String getProducts = "select Product_ID from InvoiceProduct where Invoice_ID = ?";
        try {
            ps1 = conn.prepareStatement(getInvoice);
            rs1 = ps1.executeQuery();
            while (!rs1.isLast()) {
                rs1.next();
                ps2 = conn.prepareStatement(getProducts);
                ps2.setInt(1, rs1.getInt("Invoice_ID"));
                ...
                rs2.close();
                ps2.close();
                ir.invoices.add(new Invoice(rs1.getString("InvoiceCode"),
                        rs1.getString("CustomerCode"), rs1.getString("PersonCode"),
                        rs1.getString("InvoiceDate"), products));
